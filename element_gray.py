...
layout = [
    ...
    [sg.Button('Delete', size=(7, 1), disabled=True, key='_DELBUTTON_',
     ...
     sg.Checkbox('', key='_LOCKDEL_', enable_events=True, background_color='Dark Grey'),
    ...
    #  sg.Text('', justification='right'),
     ...
     button_color=('white', 'green'), bind_return_key=True)],
    # [sg.Image(key='_IMAGE1_', filename=empty_image, visible=True,
    #  pad=((15, 0), (0, 10))),
    #  sg.Image(key='_IMAGE3_', filename=empty_image, visible=True,
    #  pad=((20, 0), (0, 10)))],
    [sg.Text('', background_color='Dark Grey')],
    [sg.Text('', key='_STATUS_', justification='left', background_color='Dark Grey')],
...
while True:
    ...
    if values['_MARKERTYPE_'] != [] and values['_LISTBOX_'] != [] \
        ...
        if font_type != '' and QS != '' and image_location != '':
            ...
            store_folder_rc = '/home/mhbrt/Desktop/Wind/Multiscale/Auto_Collection_Gray/Raw_Cut/' \
                              + font_type + '/' + char_name
            ...
            cv2.imwrite(output_name_rc, img_rc)
